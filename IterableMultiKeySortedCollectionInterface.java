...
/**
 * This interfaces extends the SortedCollectionInterface to allow storing multiple values for a
 * single key, and to iterate over the keys and values stored in the data structure.
 */
